...
import com.bookmymoviesapp.authorizationService.model.ForgetPassword;
...
public class UserService {
	...
	User user=new User();
	user.setFullName("satyamTrivedi");
	user.setUserName("satyam");
	user.setEmail("satyam@gmail.com");
	user.setUserPassword(getEncodedPassword("satyam@123"));
	Set<Role> userRoles=new HashSet<>();
	userRoles.add(userRole);
	user.setRole(userRoles);
	user.setSecretQuestion("What is your pet name");
	user.setSecretAnswer("Tiya");
