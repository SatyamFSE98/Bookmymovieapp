...
import com.bookmymoviesapp.repository.MovieRepository;
import com.bookmymoviesapp.service.MovieService;
import com.bookmymoviesapp.service.SessionService;
import com.bookmymoviesapp.service.TicketService;
...
//	Producer producer;
	...
	public ResponseEntity<?> addMovie(@RequestBody Movie movie)
			throws DuplicateMovieNameException, DuplicateMovieIdExceptions, Exception {
	...
	public ResponseEntity<?> deleteMovieById(@PathVariable("movieName") String movieName,
			@PathVariable("theatreName") String theatreName) throws Exception {
		ForAdmin();
	...
	public void ForAdmin() throws Exception {
		...
		if (!sessionUserType.equals("admin")) {
			System.out.println("This method is only for admin!");
	...
	public void ForUser() throws Exception {
		...
		if (!sessionUserType.equals("user")) {
			System.out.println("This method is only for user type!");
