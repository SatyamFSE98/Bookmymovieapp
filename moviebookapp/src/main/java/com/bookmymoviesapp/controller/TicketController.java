...
//	Producer producer;
	...
	public ResponseEntity<?> addTicket(@PathVariable("movieId") int movieId,
			@PathVariable("seatsBooked") int seatsBooked) throws Exception {
		...
		if (m1 != null) {
			...
			if (seatsAvailable - seatsBooked < 0) {
				...
				return new ResponseEntity<String>(
						"Ticket cannot be created as seats you are trying to book is more than available seats",
